...
from authorship_tool.util import LGBMResultModel, LGBMSourceModel


class LGBMTrainerUtil:
    """LightGBMを使って、著者推定モデルを学習させるクラス"""

    @classmethod
    def learn_until_succeed(cls, training_dto: LGBMSourceModel) -> LGBMResultModel:
        ...
        while True:
            training_result: LGBMResultModel = cls.learn(training_dto)
    ...
    @classmethod
    def learn(cls, training_dto: LGBMSourceModel) -> LGBMResultModel:
